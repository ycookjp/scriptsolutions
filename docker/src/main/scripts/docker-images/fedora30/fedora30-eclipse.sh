...
# Usage   : DESKTOP_ENV={lxde|mate|xfce} fedora30-eclipse.sh
# Depends : fedora30-desktop.sh, fedora30-container-base.sh, dnf.conf
# Creating image :
#   1. Start Fedora 30 and login as root.
...
ECLIPSE_URL=http://ftp.yz.yamagata-u.ac.jp/pub/eclipse/technology/epp/downloads/release/2019-03/R/eclipse-jee-2019-03-R-linux-gtk-x86_64.tar.gz
