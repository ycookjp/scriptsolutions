...
# Usage   : DESKTOP_ENV={lxde|mate|xfce} fedora31-eclipse.sh
# Depends : fedora31-desktop.sh, fedora31-container-base.sh, dnf.conf
# Creating image :
...
#         |-- eclipse-jee-2019-09-R-linux-gtk-x86_64.tar.gz
...
ECLIPSE_URL=http://ftp.yz.yamagata-u.ac.jp/pub/eclipse/technology/epp/downloads/release/2019-09/R/eclipse-jee-2019-09-R-linux-gtk-x86_64.tar.gz
