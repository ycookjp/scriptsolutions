...
# Usage   : DESKTOP_ENV={lxde|mate|xfce} fedora32-eclipse.sh
# Depends : fedora32-desktop.sh, fedora32-container-base.sh, dnf.conf
# Creating image :
#   1. Start Fedora 32 and login as root.
...
#         |-- eclipse-jee-2019-12-R-linux-gtk-x86_64.tar.gz
...
ECLIPSE_URL=http://ftp.yz.yamagata-u.ac.jp/pub/eclipse/technology/epp/downloads/release/2019-12/R/eclipse-jee-2019-12-R-linux-gtk-x86_64.tar.gz
