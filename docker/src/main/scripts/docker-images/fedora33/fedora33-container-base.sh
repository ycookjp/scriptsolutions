...
################################################################################
# Name    : fedora33-container-base
# Usage   : fedora33-container-base.sh
# Run CMD : /bin/bash
# Depends : dnf.conf
# Creating image :
...
#   4. Run this script.
#   5. Move to docker-images/fedora33-container-base directory and run
#      "tar -c . | docker import - fedora33-container-base" command.
################################################################################
