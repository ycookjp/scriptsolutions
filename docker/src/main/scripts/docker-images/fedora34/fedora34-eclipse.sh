...
# Usage   : DESKTOP_ENV={lxde|mate|xfce} fedora34-eclipse.sh
# Depends : fedora34-desktop.sh, fedora34-container-base.sh, dnf.conf
# Creating image :
...
ECLIPSE_URL=http://ftp.yz.yamagata-u.ac.jp/pub/eclipse/technology/epp/downloads/release/2021-06/R/eclipse-jee-2021-06-R-linux-gtk-x86_64.tar.gz
