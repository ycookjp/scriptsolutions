...
__unzipfile () {
  ...
  # download file
  if [ "x" != "x${__URL__}" ]; then
    curl ${__CURL_OPTS__} -L --create-dirs -o "${__FILE_PATH__}" "${__URL__}"
...
URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-datatools-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-eclipse-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-modeling.emf-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-modeling.mdt.bpmn2-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-modeling.tmf.xtext-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-mylyn-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-rt.rap-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-soa.bpmn2-modeler-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-technology.egit-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-technology.handly-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-technology.jgit-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-technology.lsp4e-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-technology.packaging-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-technology.packaging.mpc-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-technology.passage-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-technology.tm4e-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-tools.cdt-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-tools.gef-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-tools.tracecompass-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}

URL='http://www.eclipse.org/downloads/download.php?file=/technology/babel/babel_language_packs/R0.18.2/2020-12/BabelLanguagePack-webtools-ja_4.18.0.v20201226020001.zip'
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${PACKAGE_NAME}/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}
...
#URL=https://checkstyle.org/eclipse-cs-update-site/8.41.0/
#PACKAGE_NAME=org.checkstyle.eclipse-cs.8.41.0
#FILE_NAME=${PACKAGE_NAME}.zip
...
# Eclipse CDT
URL='https://ftp.jaist.ac.jp/pub/eclipse/tools/cdt/releases/10.1/cdt-10.1.0/cdt-10.1.0.zip'
PACKAGE_NAME=`basename "${URL}" .zip`
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${FILE_NAME}" \
  -x '*.sdk_* *.source_* *.gz' \
...
# JGit LFS
URL='https://ftp.jaist.ac.jp/pub/eclipse/egit/updates-5.10/org.eclipse.egit.repository-5.10.0.202012080955-r.zip'
PACKAGE_NAME=`basename "${URL}" .zip`
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${FILE_NAME}" \
  -x '*.source_* *.gz' \
...
# PyDev
URL='https://sourceforge.net/projects/pydev/files/pydev/PyDev%208.1.0/PyDev%208.1.0.zip/download'
PACKAGE_NAME=PyDev%208.1.0
FILE_NAME=${PACKAGE_NAME}.zip
__unzipfile -f dropins-archive/${FILE_NAME} \
  -x '*.source_*' \
  -u "${URL}" \
...
# StatET
URL='https://ftp.yz.yamagata-u.ac.jp/pub/eclipse/statet/releases/4.3.0/statet-repository-E202012-incubation-4.3.0-202102180600-r.zip'
PACKAGE_NAME=`basename "${URL}" .zip`
FILE_NAME=`basename "${URL}"`
__unzipfile -f dropins-archive/${FILE_NAME} \
  -u "${URL}" \
...
FILE_NAME=`basename "${URL}"`
curl ${CURL_OPTS} -L --create-dirs -o dropins-archive/${FILE_NAME} "${URL}"
if [ x != x${DL_INTERVAL} ]; then
  sleep ${DL_INTERVAL};
fi
...
# WindowsBuilder Pro
URL='https://ftp.jaist.ac.jp/pub/eclipse/windowbuilder/latest/repository.zip'
PACKAGE_NAME=WindowsBuilder_Pro-1.9.4
FILE_NAME=${PACKAGE_NAME}.zip
__unzipfile -f "dropins-archive/${FILE_NAME}" \
  -u "${URL}" \
  dropins/${PACKAGE_NAME}/eclipse
