...
# Babel
PACKAGE_NAME=BabelLanguagePack-ja_4.22.0.v20211218020001
URL_LIST="
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-datatools-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-eclipse-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-modeling.emf-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-modeling.graphiti-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-modeling.mdt.bpmn2-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-modeling.tmf.xtext-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-mylyn-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-rt.rap-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-soa.bpmn2-modeler-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-technology.egit-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-technology.handly-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-technology.jgit-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-technology.lsp4e-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-technology.packaging-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-technology.packaging.mpc-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-technology.passage-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-technology.tm4e-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-tools.cdt-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-tools.gef-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-tools.mat-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-tools.tm-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-tools.tracecompass-ja_4.22.0.v20211218020001.zip
${ECLIPSE_URL_BASE}/technology/babel/babel_language_packs/R0.19.2/2021-12/BabelLanguagePack-webtools-ja_4.22.0.v20211218020001.zip
"
...
PACKAGE_NAME=net.sf.eclipsecs.ui_9.0.0
FILE_NAME=${PACKAGE_NAME}.zip
...
# Eclipse CDT
URL='https://www.eclipse.org/downloads/download.php?file=/tools/cdt/releases/10.5/cdt-10.5.0/cdt-10.5.0.zip'
PACKAGE_NAME=`basename "${URL}" .zip`
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${FILE_NAME}" \
  -x '*.sdk_* *.source_* *.gz' \
...
# JGit LFS
URL='https://ftp.yz.yamagata-u.ac.jp/pub/eclipse/egit/updates-6.0/org.eclipse.egit.repository-6.0.0.202111291000-r.zip'
PACKAGE_NAME=`basename "${URL}" .zip`
FILE_NAME=`basename "${URL}"`
__unzipfile -f "dropins-archive/${FILE_NAME}" \
  -x '*.source_* *.gz' \
...
# PyDev
URL='https://sourceforge.net/projects/pydev/files/pydev/PyDev%209.2.0/PyDev%209.2.0.zip/download'
PACKAGE_NAME=PyDev-9.2.0
FILE_NAME=${PACKAGE_NAME}.zip
__unzipfile -f dropins-archive/${FILE_NAME} \
  -x '*.source_*' \
  -u "${URL}" \
...
# StatET
URL="${ECLIPSE_URL_BASE}/statet/releases/4.5.0/statet-repository-E202112-incubation-4.5.0-202202030600-r.zip"
PACKAGE_NAME=`basename "${URL}" .zip`
FILE_NAME=`basename "${URL}"`
__unzipfile -f dropins-archive/${FILE_NAME} \
  -u "${URL}" \
